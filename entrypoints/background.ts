...
import type { CompressionSettings, CompressionResult } from '../lib/video-processing';
...
// This is the URL for your proxy server.
// IMPORTANT: Replace this with your actual deployed server URL.
...
// Debounce processing to avoid duplicate runs
const DEBOUNCE_MS = 500;

// Define the API endpoint
// Use a variable for easier updates
const API_ENDPOINT = 'https://alttextserver.symm.app/generate-alt-text';
